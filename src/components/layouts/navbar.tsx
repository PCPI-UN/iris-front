          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            {shouldShowBackButton && (
              <Button
                ...
                onClick={handleBack}
                aria-label="Volver"
                className="h-9 w-9 shrink-0 glass-effect border border-primary/40 text-primary hover:text-foreground hover:border-primary/60 shadow-[0_0_18px_oklch(0.75_0.15_195/0.45)] sm:h-10 sm:w-10 lg:h-8 lg:w-8"
              >
                <ArrowLeft size={18} className="drop-shadow-[0_0_6px_oklch(0.75_0.15_195/0.7)] lg:h-4 lg:w-4" />
              </Button>
            )}
...
{/* Show navigation links where it's due */}
          {shouldShowNavLinks && (
            <div className="hidden text-sm lg:absolute lg:left-1/2 lg:flex lg:-translate-x-1/2 lg:items-center lg:gap-8">
              <a
                href="#informacion"
          ...
          <div className="flex items-center gap-3">
            ...
            {shouldShowNavLinks && (
              <button
                ...
                className="nav-menu-toggle lg:hidden p-2 text-white hover:text-white/85 transition-colors"
      ...
      {shouldShowNavLinks && (
        <div
          className={`fixed top-[68px] sm:top-[72px] left-0 right-0 z-30 lg:hidden transition-all duration-300 ${
